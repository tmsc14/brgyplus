...
<div class="document-body">
    ...
    <div class="document-content">
        ...
        <p>This is to certify that {{ $previewData['salutation'] }} {{ $previewData['fullName'] }}, whose
            personal data appears below, is a <b>RESIDENT</b> of this Barangay and personally known with good moral
            character, law-abiding citizen, and has a respectable reputation in this community.</p>
        ...
        <div class="resident-information">
            ...
            <div>
                <span class="key">Civil status</span><span
                    class="colon">:</span>&nbsp;{{ $previewData['civilStatus'] }}
            </div>
            <div>
                <span class="key">Gender</span><span class="colon">:</span>&nbsp;{{ $previewData['gender'] }}
            </div>
            <div>
                <span class="key">Address/Street</span><span
                    class="colon">:</span>&nbsp;{{ $previewData['address'] }}
            </div>
            <div>
        ...
        <p>This certification issued upon the request of the aforementioned individual for whatever legal
